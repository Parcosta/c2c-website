...
export function HeroBlock({ className, audioSrc, audioTitle, locale, content }: HeroBlockProps) {
  return (
    <section
      ...
      <Container className="relative py-16 sm:py-20 md:py-24">
        <div className="max-w-4xl space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-body text-gray-200">{content.heroSubtitle}</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <AnimatedButton asChild size="lg" className="rounded-full px-8">
              <Link href={`/${locale}/contact`}>{content.heroCtaPrimary}</Link>
            </AnimatedButton>
            <AnimatedButton asChild variant="secondary" size="lg" className="rounded-full px-8">
              <Link href={`/${locale}/portfolio`}>{content.heroCtaSecondary}</Link>
            </AnimatedButton>
          </div>
        </div>
      </Container>
