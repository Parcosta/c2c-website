    ...
    return (
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none">
          <p>
            Esta política de privacidad describe cómo se recopila, utiliza y protege tu información.
          </p>
          <h2>Información que recopilamos</h2>
          <p>
            Recopilamos información que nos proporcionas directamente, como tu nombre y correo
            electrónico cuando nos contactas.
          </p>
          <h2>Cómo utilizamos tu información</h2>
          <p>
            Utilizamos tu información para responder a tus consultas y mejorar nuestros servicios.
          </p>
        </div>
      </main>
    );
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          We collect information you provide directly to us, such as your name and email when you
          contact us.
        </p>
